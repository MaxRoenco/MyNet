    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#7B61FF] to-[#5B47CC] p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Sign in to continue to MyNet</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" className="text-sm text-[#7B61FF] hover:text-[#6951E0] transition-colors">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/register" className="text-[#7B61FF] font-semibold hover:text-[#6951E0] transition-colors">
              Sign up
            </Link>
          </p>
        </div>
