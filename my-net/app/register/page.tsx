    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#7B61FF] to-[#5B47CC] p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Join MyNet today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start">
            <input
              ...
              className="w-4 h-4 mt-1 text-[#7B61FF] border-gray-300 rounded focus:ring-[#7B61FF]"
            />
            <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
              I agree to the{' '}
              <Link href="/terms" className="text-[#7B61FF] hover:text-[#6951E0] transition-colors">
                Terms and Conditions
              </Link>{' '}
              and{' '}
              <Link href="/privacy" className="text-[#7B61FF] hover:text-[#6951E0] transition-colors">
                Privacy Policy
              </Link>
            </label>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/login" className="text-[#7B61FF] font-semibold hover:text-[#6951E0] transition-colors">
              Sign in
            </Link>
          </p>
        </div>
